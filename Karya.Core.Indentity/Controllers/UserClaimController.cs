...
[Authorize]
public class UserClaimController : BaseCrudController<AppUserClaim, int, AppUserClaimSDto, AppUserClaimLDto, AppUserClaimADto, AppUserClaimUDto>
{
    public UserClaimController(IMediator mediator, DbContext context, ICurrentUser currentUser)
